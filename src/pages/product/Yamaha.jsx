        ...
        <div className="min-h-screen bg-bg-light pb-20">
            <div className="container pt-20 pb-12">
                <div className="flex flex-col gap-4 mb-16">
                    <span className="text-[12px] font-bold text-primary italic uppercase tracking-widest">Kando (Emotion) & Performance</span>
                    <h1 className="text-display-title">YAMAHA</h1>
                    <p className="text-body font-bold text-text-muted max-w-2xl">감동의 야마하, 감각적인 디자인과 탁월한 엔진 성능을 자랑하는 렌탈 라인업을 확인하세요.</p>
                </div>
                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {yamahaBikes.length > 0 ? (
                                    ...
                                    <Link to={`/product/detail/${bike.slug}`} className="group flex flex-col gap-4 p-4 bg-white rounded-xl border border-border-subtle shadow-sm hover:shadow-xl transition-all duration-500">
                                        ...
                                        <div className="flex flex-col gap-4">
                                            <div className="flex flex-col gap-1">
                                                ...
                                                <span className="text-[12px] font-bold text-text-muted uppercase tracking-widest">야마하</span>
                            ...
                            <div className="col-span-full py-20 text-center font-bold text-text-muted">등록된 YAMAHA 모델이 없습니다.</div>
                        )}
                    </div>
                )}
            </div>
