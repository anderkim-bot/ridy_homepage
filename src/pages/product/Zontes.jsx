...
const Zontes = () => {
    ...
    useEffect(() => {
        const loadBikes = async () => {
            try {
                ...
                const filtered = data.filter(b => b.brand === 'ZONTES' && b.items?.some(item => item.image));
                const sorted = filtered.sort((a, b) => (b.isPopular ? 1 : 0) - (a.isPopular ? 1 : 0));
                setZontesBikes(sorted);
            } catch (error) {
    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <ProductTabs activeBrand="ZONTES" />
                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
                        {zontesBikes.length > 0 ? (
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col p-5 gap-4 flex-1">
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <div className="pt-2">
                                                    <span className="block text-[11px] font-black text-slate-300 uppercase tracking-widest mb-1">ZONTES</span>
                            ...
                            <div className="col-span-full py-20 text-center font-bold text-slate-400 bg-white rounded-xl border border-slate-100">등록된 ZONTES 모델이 없습니다.</div>
                        )}
                    </div>
                )}
            </div>
