...
const Footer = () => {
    ...
    return (
        <footer className="bg-bg-white border-t border-[#E0E0E0]">
            ...
            {!shouldHideCta && (
                <div className="bg-bg-dark py-8 md:py-10 px-[20px] md:px-[60px]">
            ...
            <div className="py-8 md:py-12 px-[20px] md:px-[60px]">
                <div className="container">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-8 md:mb-12">
                        ...
                        <div>
                            <h4 className="text-[14px] font-bold text-text-secondary mb-4">서비스</h4>
                        ...
                        <div>
                            <h4 className="text-[14px] font-bold text-text-secondary mb-4">고객지원</h4>
                            <ul className="flex flex-col gap-4 text-[12px] text-text-muted">
                    ...
                    <div className="pt-6 border-t border-[#E0E0E0] flex flex-col md:flex-row justify-between items-center text-[12px] text-text-muted gap-6">
